...
def mainpage():
    ...
    return render_template('mainpage.html', suggestions=suggestions)
...
def recommend():
    ...
    movie_posters = {rec_posters[i]: rec_movies[i] for i in range(len(rec_posters))}
    ...
    return render_template('recommend.html', title=title, poster=poster, overview=overview, vote_average=vote_average,
                           ...
                           genres=genres,
                           movie_posters=movie_posters, reviews=movie_reviews, casts=casts, cast_details=cast_details)
